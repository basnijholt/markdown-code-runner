...
- [:rocket: Markdown Code Runner](#rocket-markdown-code-runner)
  ...
  - [:bulb: Usage Ideas](#bulb-usage-ideas)
    ...
    - [:star: Example 3: Generating a table from CSV data](#star-example-3-generating-a-table-from-csv-data)
    - [:star: Example 4: Displaying API data as a list](#star-example-4-displaying-api-data-as-a-list)
